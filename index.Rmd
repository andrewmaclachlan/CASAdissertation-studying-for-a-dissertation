...
* Set yourself up for a dissertation 
...
* Use research language in relation to your thesis 
...
`r countdown(minutes=1, seconds =30, warn_when = 10, bottom=0, left=0)`
---
...
* Specific BUT relevant detail - second one talks about the bast then says it's imperative now?  
* Selling the analysis to us - do fires happen more in the UK? says who? vs...49,340 pedestrians were killed by moving vehicles between 2008 and 2017
...
`r countdown(minutes=1, seconds =0, warn_when = 10, bottom=0, left=0)`
...
`r countdown(minutes=0, seconds =45, warn_when = 10, bottom=0, left=0)`
...
* the results aren't just stated...Figure x shows this, Figure Y shows this...the results re interpreted and then used to further the analysis and or in relation to other results. 
...
`r countdown(minutes=0, seconds =30, warn_when = 10, bottom=0, left=0)`
...
* It's clear **what** they did and **WHY that is useful**
